...
let branchesData: Branch[] = [
    { id: 1, organizationId: MOCK_ORGANIZATION_ID, name: 'Main Branch', location: 'Chennai', createdAt: new Date().toISOString() },
    { id: 2, organizationId: MOCK_ORGANIZATION_ID, name: 'Branch 2', location: 'Coimbatore', createdAt: new Date().toISOString() },
];
...
let inventoryProductsData: InventoryProduct[] = [
    {
        ...
        description: 'Samsung Galaxy S24 Ultra', price: 79999, image: undefined,
        variants: [
            { id: 1, variantName: '128GB Black', price: 79999, taxType: 'exclusive', skuId: 'SAM-S24-128B', warrantyId: 2 },
            { id: 2, variantName: '256GB Silver', price: 89999, taxType: 'exclusive', skuId: 'SAM-S24-256S', warrantyId: 2 },
        ],
    ...
    },
    {
        ...
        description: 'Premium organic green tea - 100 bags', price: 299, image: undefined,
