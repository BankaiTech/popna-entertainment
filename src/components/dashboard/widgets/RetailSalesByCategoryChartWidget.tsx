...
export default function RetailSalesByCategoryChartWidget() {
    ...
    <Card className="overflow-hidden">
      ...
      <CardHeader className="py-3">
        <CardTitle className="text-sm sm:text-base">
          {t('dashboard.retail.salesByCategory', 'Sales by Category')}
        </CardTitle>
      </CardHeader>
      <CardContent className="py-2">
          ...
          <ResponsiveContainer width="100%" height="100%">
            <PieChart>
              <Pie
                ...
                paddingAngle={2}
              >
                {mockData.salesByCategory.map((_: unknown, index: number) => (
        ...
        <div className="flex flex-wrap gap-3 mt-2 justify-center">
          {mockData.salesByCategory.map((item: { name: string; value: number }, index: number) => (
