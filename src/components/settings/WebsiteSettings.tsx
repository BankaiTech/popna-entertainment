    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Configure homepage content and appearance. Multi-tenant ready — backend will isolate by organization.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              <Input
                ...
                placeholder="Cable & Internet Services"
                required
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Choose the right plan for your home or business."
        ...
        <Card>
          <CardHeader>
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Add feature cards to showcase your services
            </p>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            {formData.highlightCards && formData.highlightCards.length > 0 && (
              <div className="space-y-2 pt-4 border-t border-border">
                <p className="text-sm font-medium text-foreground mb-2">Existing Cards:</p>
