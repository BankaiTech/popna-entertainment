...
export const INDUSTRY_TEMPLATES: IndustryTemplate[] = [
  {
    ...
    terminology: { customer: 'Subscriber', contact: 'Subscribers', complaint: 'Ticket', connectionType: 'Service Plan', subscription: 'Plans' },
  ...
  },
  {
    ...
    terminology: { customer: 'Dealer', contact: 'Dealers' },
  ...
  },
  {
    ...
    enabledSettingsTabs: ['company', 'products', 'billing', 'pos'],
    terminology: { customer: 'Guest', contact: 'Guests', appointment: 'Reservations', product: 'Menu Items' },
  ...
  },
  {
    ...
    enabledSettingsTabs: ['company', 'products', 'billing', 'pos', 'custom-fields'],
    terminology: { customer: 'Client', contact: 'Clients', appointment: 'Bookings', product: 'Services' },
  ...
  },
  {
    ...
    enabledSettingsTabs: ['company', 'products', 'billing', 'pos', 'custom-fields'],
    terminology: { customer: 'Patient', contact: 'Patients', appointment: 'Consultations' },
  ...
  },
  {
    ...
    enabledSettingsTabs: ['company', 'products', 'billing', 'pos', 'custom-fields'],
    terminology: { customer: 'Member', contact: 'Members', subscription: 'Memberships', appointment: 'Sessions' },
  ...
  },
  {
    ...
    terminology: { customer: 'Client', contact: 'Clients', quotation: 'Proposal', lead: 'Prospects' },
  ...
  },
  {
    ...
    enabledSettingsTabs: ['company', 'billing', 'custom-fields'],
    terminology: { customer: 'Student', contact: 'Students', subscription: 'Enrollments', appointment: 'Classes' },
  ...
  },
  {
    ...
    enabledSettingsTabs: ['company', 'products', 'billing', 'pos', 'custom-fields'],
    terminology: { customer: 'Vehicle Owner', contact: 'Vehicle Owners', serviceRequest: 'Job Cards', appointment: 'Service Bookings' },
  ...
  },
  {
    ...
    enabledSettingsTabs: ['company', 'billing', 'custom-fields'],
    terminology: { customer: 'Client', contact: 'Clients', quotation: 'Proposals' },
